    ...
    <div className="signInPage">
        <CircularComponent className="firstCircle"/>
            ...
            <div className='signInContainer'>
                ...
                <input onChange={(e)=>{setTeamName(e.target.value)}} type="text" id='team-name' value={teamName} placeholder='Enter your team name' />
                </div>

                <div className="input-div email-input">
                <label htmlFor="email">Email</label>
                <input onInput={(e)=>{setEmail(e.target.value)}} type="text" id='email' value={email} placeholder='Enter your email' />
                </div>
